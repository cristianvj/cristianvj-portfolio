...
const HeroSection = () => {
  ...
  return (
    ...
    `}>
      <div className={`w-full md:w-[35%] md:pt-4 md:pl-4 absolute left-1 z-20 ${darkMode ? 'bg-slate-800' : 'bg-slate-200'} p-5 rounded-xl bg-opacity-60`}>
        <h1 className={`
           bg-opacity-100 text-3xl md:text-6xl
