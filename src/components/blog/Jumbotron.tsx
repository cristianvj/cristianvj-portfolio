...
const Jumbotron: FC = () => {
  return (
    <div className="w-full flex flex-col lg:flex-row lg:flex-nowrap justify-between items-start gap-6 mb-3">
      ...
      <div className="w-full lg:max-w-[50%] bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        <picture>
        ...
        <div className="p-5">
            ...
            <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">Aqui encontrarás un <Link href={`/interview`} className='dark:text-gray-200 dark:hover:underline'>banco de preguntas y respuestas frecuentes</Link>, así como recursos muy útiles para prepararte para tus entrevistas de trabajo como react developer y resolver ciertos bugs que día a día nos enfrentamos como desarrolladores web React, Mobile y 3D.</p>
      ...
      <div className='w-full lg:max-w-[50%] flex flex-col items-start gap-6'>
        ...
        <div className='w-full rounded-lg bg-white dark:bg-gray-800 p-4'>

          <h5 className="text-2xl font-bold text-gray-900 dark:text-white">Sobre el autor</h5>
            <div className="flex flex-row flex-nowrap gap-5 items-center my-3">
              ...
              <div>
                ...
                <p className="text-lg font-normal text-gray-500 dark:text-gray-200">Ingeniero de sistemas, desarrollador de interfaces 3D y web apps con React.js. </p>
              </div>
            </div>
            <p className="text-md font-normal text-gray-500 dark:text-gray-400"><span className='text-orange-600'>Skills: </span> Javascript ES6, Typescript, Node.js, React.js, Next.js, Three.js, Redux, GraphQL, Git, Storybook, Tailwind, Material UI</p>
        ...
        <section className="bg-gray-50 dark:bg-gray-900 w-full">
                <div>
                    <div className="w-full p-6 space-y-3 sm:p-8 bg-white rounded-lg shadow-xl dark:bg-gray-800">
                        <h2 className="text-2xl font-semibold text-gray-900 dark:text-white">
                            Entérate cuando escriba nuevos posts
                        </h2>
                        <form className="mt-8 space-y-4" action="#">
                            <div>
                                <label htmlFor="email" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Déjame tu email, cero spam</label>
                                <input type="email" name="email" id="email" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-orange-500 focus:border-orange-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-orange-500 dark:focus:border-orange-500" placeholder="name@company.com" required />
                            </div>
