export const classes = {
  navbarLi: {
    ...
    active: "block py-2 pl-3 pr-4 text-white bg-orange-600 rounded lg:bg-transparent lg:text-orange-600 lg:p-0 ",
    activeDark: "dark:text-white lg:dark:text-orange-600",
  },
  navbarIcons: {
