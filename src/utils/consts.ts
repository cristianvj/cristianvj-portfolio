...
export const classes = {
  ...
  blog: {
    ...
    h5Dark: 'text-slate-100', 
    h5Light: 'text-slate-800', 
    pDark: 'text-slate-200', 
    pLight: 'text-slate-800', 
    spanDark: 'text-slate-400', 
    spanLight: 'text-slate-500',
    orangeSpan: 'font-semibold text-orange-600',
  }
};
